# 1.	Create a python script to use in lambda function and convert into zip format
# 2.	Upload this zip file into s3 bucket.
# 3.	Call lambda function zip file from s3 bucket to ec2 instance.
